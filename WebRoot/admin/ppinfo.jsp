...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommDAO dao = new CommDAO(); 
	 ...
	 String url = "/newspubsys/admin/ppinfo.jsp?1=1";
				...
				<div class="btn-toolbar">
					<div class="search-well">
						<form action="admin/ppinfo.jsp?f=f" method="post" class="form-inline">
							<input class="input-xlarge" placeholder="名称..." id="key" name="key" type="text" value="<%=key %>">
		                    <button class="btn" type="submit"><i class="icon-search"></i> Go</button>
						    <button class="btn btn-primary" onclick="ppinfoadd()" type="button"><i class="icon-plus"></i> 新闻栏目</button>
						</form>	
					</div>  	
				</div>
