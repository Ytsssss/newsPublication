	...
	<div id="page-content" class="single-page">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						<li><a href="projectedit.jsp?id=<%=id %>">编辑新闻</a></li>
					</ul>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="heading"><h2>编辑新闻</h2></div>
					<form name="form2" id="ff2" method="post" action="/newspubsys/newspubsys?ac=newsedit&id=<%=id %>" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<select id="type" name="type" class="input-xlarge" required>
								    ...
								    <option value="<%=ppmap.get("id") %>" <%if(ppmap.get("id").equals(map.get("type"))){out.print("selected==selected");} %>><%=ppmap.get("ppname") %></option>
								    <%} %>
							</select>
						</div>
						<div class="form-group">
							内容：<textarea id="editor_id" id="note" name="note" style="width:1000px;height:400px;" ><%=map.get("note")%></textarea>
						</div>
